...
# Sticker Function Default Arguments--------------------------- 
...
xtract_img <- magick::image_read('extraction.png')

fonts_dataset <- font_files()

font_add("Trebuchet MS", "Trebuchet MS.TTF")
...
sticker(
  ...
  p_color = 'violetred',
  p_size = 30,
  p_family = "Trebuchet MS",
  filename = "xtractr-hexSticker-gold.png" 
  ) %>% print()
